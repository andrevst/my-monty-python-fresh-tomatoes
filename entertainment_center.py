...
and_now_for_something_completely_different = media.Movie(
    ...
    "1971",
    """And Now for Something Completely Different is a British comedy film
    based on the television comedy series Monty Python's Flying Cicus""",
...
the_holy_grail = media.Movie(
    ...
    "1975",
    """932 AD, King Arthur travel throughout Britain searching men to join the
    Knights of the Round Table. To find the Holy Grail.""",
...
life_of_brian = media.Movie(
    ...
    He grows up an idealistic young man who resents the Roman occupation.""",
